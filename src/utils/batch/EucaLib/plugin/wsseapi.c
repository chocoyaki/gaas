...
/* gSOAP runtime so as not to create a dependency on the gSOAP library.     */
/* This save the trouble of dealing with the gSOAP WS-Security module       */
/* that is included in the package distribution.                            */
/*                                                                          */
/* Author(s):                                                               */
...
/* $Id$
 * $Log$
 * Revision 1.1  2010/05/05 13:13:52  amuresan
...
wsu:Id attribute values are set to the string value of the tag's QName.
@param soap context
