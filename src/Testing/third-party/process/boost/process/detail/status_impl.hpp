...
int
wait(pid_type pid, boost::system::error_code &ec) {
#if defined(BOOST_POSIX_API)
  pid_t p;
  int status;
  do {
...
template <typename Handler>
void
async_wait(phandle ph, Handler handler) {
...
#endif // ifndef BOOST_PROCESS_DETAIL_STATUS_IMPL_HPP
