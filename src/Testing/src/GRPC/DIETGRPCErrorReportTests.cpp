...
BOOST_AUTO_TEST_CASE(error_reporting_test_2) {
  ...
  err = -1;
  BOOST_TEST_MESSAGE(
    "  A non-defined error code (" << err << ") corresponds to '" <<
