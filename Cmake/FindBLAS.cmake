...
IF( NOT BLAS_FOUND )
  ...
  IF(APPLE)
     BLAS_CHECK_LIBRARY( "g2c"   "_do_fio" "${BLAS_PATHS}" FOUND_G2C )
  ENDIF(APPLE)

  IF( FOUND_ATLAS AND FOUND_f77BLAS AND FOUND_CBLAS )	
    SET( BLAS_FOUND "YES" )
    SET( BLAS_LIBRARIES ${FOUND_CBLAS} ${FOUND_G2C} ${FOUND_f77BLAS} ${FOUND_ATLAS} CACHE FILEPATH "BLAS libraries" )
    FILE( APPEND ${CMAKE_BINARY_DIR}/CMakeOutput.log 
...
ENDIF( NOT BLAS_FOUND )
   ...
   IF (APPLE AND BLAS_FOUND AND NOT FOUND_G2C)
    SET( BLAS_FOUND "NOT" )
   ENDIF(APPLE AND BLAS_FOUND AND NOT FOUND_G2C)
...
IF( NOT BLAS_FOUND )
  ...
  MESSAGE("    cmake .. -DBLAS_DIR:PATH=/usr/lib ")
