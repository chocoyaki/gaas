...
ELSE( NOT JUXMEM_XML2_CONFIG_COMMAND )
  EXEC_PROGRAM( ${JUXMEM_XML2_CONFIG_COMMAND}
    ARGS --libs
...
ELSE( NOT JUXMEM_PKG-CONFIG_COMMAND )
  EXEC_PROGRAM( ${JUXMEM_PKG-CONFIG_COMMAND}
    ARGS "openssl --libs"
...
ELSE( NOT JUXMEM_APR-CONFIG_COMMAND )
  EXEC_PROGRAM( ${JUXMEM_APR-CONFIG_COMMAND}
    ARGS --libs
...
ELSE( NOT JUXMEM_APU-CONFIG_COMMAND )
  EXEC_PROGRAM( ${JUXMEM_APU-CONFIG_COMMAND}
    ARGS --libs
