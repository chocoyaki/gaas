...
SET( CTEST_SOURCE_DIRECTORY "$ENV{HOME}/DashboardDiet/rizWorkflow/cvs/${CVS_MODULE_DIRECTORY}" )
SET( CTEST_BINARY_DIRECTORY "${CTEST_SOURCE_DIRECTORY}/Bin" )

SET( CTEST_CVS_COMMAND "/usr/bin/cvs" )

SET( CTEST_CVS_CHECKOUT "${CTEST_CVS_COMMAND} -d:ext:dart@graal.ens-lyon.fr:/home/CVS/graal co -N -d$ENV{HOME}/DashboardDiet/rizWorkflow/cvs ${CVS_MODULE_DIRECTORY}" )
...
/////////////////////////////////////////////// LOCALISATION
//Name of the build
BUILDNAME:STRING=Debian-GCC_3.3.5-Workflow

//Name of the computer/site where compile is being run
SITE:STRING=riz.ens-lyon.fr
