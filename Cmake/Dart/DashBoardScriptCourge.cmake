...
SET( CTEST_SOURCE_DIRECTORY "$ENV{HOME}/DashboardDiet/courge/cvs/${CVS_MODULE_DIRECTORY}" )
SET( CTEST_BINARY_DIRECTORY "${CTEST_SOURCE_DIRECTORY}/Bin" )

SET( CTEST_CVS_COMMAND "/usr/bin/cvs" )

SET( CTEST_CVS_CHECKOUT "${CTEST_CVS_COMMAND} -d:ext:dart@graal.ens-lyon.fr:/home/CVS/graal co -N -d$ENV{HOME}/DashboardDiet/courge/cvs ${CVS_MODULE_DIRECTORY}" )
...
/////////////////////////////////////////////// LOCALISATION
//Name of the build
BUILDNAME:STRING=Debian-GCC_3.2.5-Docs-Batch-Blas-Fd-Juxmem-Jxta-Workflow

//Name of the computer/site where compile is being run
SITE:STRING=courge.ens-lyon.fr
