...
\texttt{smprod}~\footnote{Source code available \texttt{doc/tutorial/solutions/exercise2/client\_smprodAsync.c}} for scalar by matrix product.
{\footnotesize
\begin{verbatim}
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char **argv)
{
  ...
  for (i = 0; i < 5; i++){
    ...
    diet_matrix_set(diet_parameter(profile[i],1), matrix[i],  0, DIET_DOUBLE, 60, 100, DIET_COL_MAJOR);
