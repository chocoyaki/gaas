...
\fixme{Holly: The following 2 paragraphs are confusing.  Do we
support GridRPC interfaces or not?  We no longer have a notion of
function handles ...}
...
DIET libraries and the CORBA libraries. The easiest way to compile a
program using DIET with all necessary flags and link it with the
right libraries is to trust the \texttt{Makefile.inc} available in
