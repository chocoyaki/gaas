...
%* $Id$
%* $Log$
%* Revision 1.21  2011/05/02 07:35:09  bdepardo
%* Corrected a few typos
%*
%* Revision 1.20  2010/04/01 10:11:50  bdepardo
%* Changed	deprecated INSTALL_FILES and INSTALL_TARGETS to	INSTALL.
%*
%* Revision 1.19  2010/03/29 21:04:16  ecaron
%* Remove information about autotools compilation (outdated)
%*
