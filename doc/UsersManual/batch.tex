...
%* $Id$
%* $Log$
%* Revision 1.11  2010/02/25 06:45:38  ycaniou
%* Add local variables
%*
%* Revision 1.10  2008/07/17 09:21:53  ycaniou
%* Removed compilation warning
%*
%* Revision 1.9  2008/07/17 09:03:22  ycaniou
%* Update Cmakelist in order not to copy batch examples.c anymore since removed
%*   from the doc
%* Add label in prediction.tex and correct batch.tex correspondingly
%*
%* Revision 1.8  2008/07/16 22:51:50  ecaron
%* Remove examples (keep only references)
%*
%* Revision 1.7  2008/07/08 16:50:10  glemahec
...
For the moment, \diet has some internal mechanisms to launch external
...
data on the parallel resource. Please note that this directory is used
...
concerning OAR (v1.6), in order to use the CoRI\_batch features (see
Section~\ref{section:cori_batch}), the Batch \sed deployer must also
provide the keyword \verb$internQueue$ with the corresponding name.
...
let \diet choose the best (by default, two processors are used and the
...
according to the site where he deploys \diet. 
