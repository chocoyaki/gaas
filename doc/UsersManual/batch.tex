...
%* $Id$
%* $Log$
%* Revision 1.18  2011/05/03 07:31:10  bdepardo
%* Typo
%*
%* Revision 1.17  2011/05/02 10:01:43  bdepardo
%* Corrected a few typos.
%* Renamed "round-robin" scheduler into "least recently used" scheduler as this
%* is closer to the behavior of this scheduler.
%*
%* Revision 1.16  2011/03/30 21:50:49  ecaron
%* Update style to be compliant to latex2html
%*
