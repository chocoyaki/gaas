...
%* $Id$
%* $Log$
%* Revision 1.19  2010/02/25 08:55:43  ycaniou
%* Add a couple of macro like \seddiet \sedj (differs from \sed$_\diet$ which
%*   adds a space)
%* Changed *.tex accordingly
%*
%* Revision 1.18  2010/02/25 06:45:38  ycaniou
%* Add local variables
%*
%* Revision 1.17  2009/09/07 16:07:47  bdepardo
%* Added CCS mode.
%* A few corrections:
%* - DIET -> \diet
%* - SeD -> \sed
%*
%* Revision 1.16  2008/07/17 21:54:32  ecaron
%* Update scale for figures
%*
%* Revision 1.15  2008/07/17 21:31:46  ecaron
%* To be compliant to latextohtml (use scale instead of resizebox)
%*
%* Revision 1.14  2008/07/17 09:28:19  dloureir
%* changing fig:platform to fig:platformjxta in order to solve label multiply defined when compiling the doc
%*
%* Revision 1.13  2008/07/16 22:59:36  ecaron
...
\chapter{P2P \diet extension: \dietj}
...
\begin{figure}[htb]
 \begin{center}
   \includegraphics[scale=0.6]{fig/global_platform_jxta}
%%   \label{fig:platform}
