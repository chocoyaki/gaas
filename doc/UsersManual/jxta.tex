...
\subsubsection{The JXTA Multi-MA}
...
\item{Download from
    ...
    extract the JAR files of the last stable JXTA release (DIET/JXTA
    is based on JXTA 2.2 and has been successfully tested with JXTA
    2.3). Files to download are :}
\begin{itemize}
\item{\texttt{jxta.jar},}
