...
%* $Id$
%* $Log$
%* Revision 1.7  2011/02/16 18:09:15  bdepardo
...
%* configuration files.
%*
%* Revision 1.6  2010/10/28 10:20:37  bdepardo
%* Added missing parameters --nb-retry, --peer-ior
%*
%* Revision 1.5  2010/10/28 10:12:35  bdepardo
%* Added missing option --remote-host.
%*
...
\textit{accept~=~} or \textit{reject~=~} followed by a regular
expression.\\
