...
%* $Id$
%* $Log$
%* Revision 1.8  2010/02/25 06:45:38  ycaniou
%* Add local variables
%*
%* Revision 1.7  2008/07/17 21:31:46  ecaron
%* To be compliant to latextohtml (use scale instead of resizebox)
%*
%* Revision 1.6  2008/07/15 23:11:45  ecaron
%* Typo
%*
%* Revision 1.5  2008/04/07 22:25:38  ecaron
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.7]{fig/multima}
   \label{fig:multima}
