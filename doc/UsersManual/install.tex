...
When configured to use FAST, DIET servers are able to provide better
...
\fixme{FAST dependencies should be described elsewhere in a
FAST-specific section!}
FAST depends on:
\begin{itemize}
...
\subsubsection{BLAS}
\fixme{Should we shorten BLAS section or move to examples chapter?}
...
\fixme{Should we shorten ScaLAPACK section or move to examples chapter?}
