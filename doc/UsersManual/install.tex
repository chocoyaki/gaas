...
%* $Id$
%* $Log$
%* Revision 1.28  2006/11/13 19:44:11  eboix
%*    - cmake now generates an Bin/include/Makefile.inc for make inclusion
%*    - DIET_USE_BLAS option renamed to DIET_BUILD_BLAS_EXAMPLES
%*    - DIET_WITH_ALTPREDICT option added (and apparently the code seems
%*      bugged when this options is turned on). --- Injay2461
%*
