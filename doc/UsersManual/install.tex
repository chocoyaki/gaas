...
%* $Id$
%* $Log$
%* Revision 1.51  2011/01/13 16:36:16  bdepardo
%* Installation flags for cmake
%*
%* Revision 1.50  2010/05/25 08:04:49  bdepardo
%* Fixmes removal
%*
%* Revision 1.49  2010/03/31 06:04:23  ycaniou
%* Add batch example explaination
%* Typo--
%*
%* Revision 1.48  2010/03/31 05:47:21  ycaniou
%* Typos + options order
%*
%* Revision 1.47  2010/03/29 23:11:57  ecaron
%* - Add information about windows
%* - Corrections
%*
%* Revision 1.46  2010/02/25 08:05:27  ycaniou
%* e.g -> Use macro
%* Typo + ispell
%*
%* Revision 1.45  2010/02/25 07:46:42  ycaniou
%* ie, i.e -> Use macro
%* Typos + ispell
%*
%* Revision 1.44  2010/02/25 06:38:15  ycaniou
%* Add local variable
%* + Ispell
%* + eg, NES etc. -> \eg..
...
%* + formatage .tex
%*
%* Revision 1.43  2010/01/21 14:05:58  bdepardo
%* DIET -> \diet
%* SeD -> \sed
%* GoDIET -> \godiet
%*
...
\diet is fully tested on Linux [with varying distributions like Debian, Red Hat
  Enterprise Linux (REL-ES-3), Fedora Core (5)], on AIX (5.3) on MacOSX
...
\item
  ...
  define new collectors or use existing collectors through CoRI's interface. 
  CoRI thus
...
\item \verb+DIET_USE_DAGDA+ enables the use of the new data management
  module of \diet. \dagda offers to the \diet application developers a 
  simple and efficient way to manage the data. See Chapter\ref{ch:dagda} for
  more details.

\item \verb+DIET_USE_DYNAMICS+ enables a mode in which you can dynamically
  modify its shape using CORBA calls. See chapter \ref{ch:dynamic} for more
...
\item
  ...
  workflow support in \diet see chapter \ref{ch:workflows}. Note that
  setting the \verb+DIET_USE_WORKFLOW+ will force the option
  %\linebreak
  \verb+DIET_USE_DAGDA+ to be set.
...
% \fixme{Sûrement à remplacer par l'équivalent pour CDash ou à enlever non ?}
\item
