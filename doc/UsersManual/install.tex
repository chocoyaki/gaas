...
Reference
Manual~\footnote{\url{http://graal.ens-lyon.fr/FAST/docs/index.html}}.
...
Once all dependencies are installed, untar the DIET archive and
...
{\footnotesize
\texttt{ tar xzf DIET\_}\dietversion\texttt{.tgz}
\begin{verbatim}
~ > cd DIET
...
\noindent This group of options lets the user define all necessary paths for compilation with the \scalapack\ libraries. Normally, \texttt{--with-ScaLAPACK=}
