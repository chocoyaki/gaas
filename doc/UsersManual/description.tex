...
performance tests (see Chapter~\ref{chapter:performance}). Figure~\ref{fig:platform} shows the hierarchical organization of \textsc{Diet}.

\begin{figure}[htb]
 \begin{center}
  \resizebox{.7\linewidth}{!}{\includegraphics{fig/global_platform}}
...
\begin{figure}[hbt]
  \begin{center}
    \resizebox{9cm}{!}{\includegraphics{fig/init}}
