...
%* $Id$
%* $Log$
%* Revision 1.30  2010/03/31 06:16:40  ycaniou
%* Ajout de fixme
%*
%* Revision 1.29  2010/03/29 21:06:36  ecaron
%* Fixme
%*
%* Revision 1.28  2010/02/25 06:45:38  ycaniou
%* Add local variables
%*
%* Revision 1.27  2010/01/21 14:05:58  bdepardo
%* DIET -> \diet
%* SeD -> \sed
%* GoDIET -> \godiet
%*
%* Revision 1.26  2008/10/22 12:02:50  bdepardo
%* Replaced DIET_BYTE by the current type which is DIET_SHORT
%*
%* Revision 1.25  2008/08/13 01:08:27  ecaron
%* diet_string_get() have only 3 arguments
%*
%* Revision 1.24  2008/07/02 13:23:55  gcharrie
%* cosmetics and some clarifications on the problem parameters
%*
%* Revision 1.23  2008/04/07 23:55:37  ecaron
%* Fix overfull box
%*
%* Revision 1.22  2008/04/07 22:25:38  ecaron
%* Updated files to pdflatex compilation
%*
%* Revision 1.21  2007/11/22 20:58:15  mimbert
%* correction on the description of struct diet_profile_t and function diet_profile_alloc
%*
...
\fixme{Comment a se passe, il y avait pas eu une histoire avec la partie
dagda?}
