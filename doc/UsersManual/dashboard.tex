...
This section talks about monitoring tools around DIET. We work on
integrated tool will call DIET Dashboard based on LogService
(section~\ref{sec:logserivce}), VizDIET (section~\ref{sec:vizdiet})
and GoDIET (section~\ref{sec:godiet}). However, each part of DIET
dashboard are already available as independant tool. This chapter
gives an overview of each of them.
