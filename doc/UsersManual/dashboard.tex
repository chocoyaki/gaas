...
\begin{figure}[htb]
  \begin{center}
    \resizebox{.6\linewidth}{!}{\includegraphics{fig/DIET_arch_request-2}}
...
\begin{figure}[htb]
  \begin{center}
    \resizebox{.5\linewidth}{!}{\includegraphics{fig/VizDIET}}
...
\begin{figure}[htb]
  \begin{center}
    \resizebox{.8\linewidth}{!}{\includegraphics{fig/VizDIET_screenshot_2}}
