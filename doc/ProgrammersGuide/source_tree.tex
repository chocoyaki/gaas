...
%* $Id$
%* $Log$
%* Revision 1.11  2006/01/25 17:26:04  pfrauenk
...
fast scheduling by the plug-in.
 ...
 \item called twice in the same tag for a scalar values, the second will erase the first
  \item called twice in the same tag for the array side of the vector, it will append the new information to the old
 \end{itemize} 
  %including of the class diagram: source file can be modified by MS visio
 %source file available on /home/CVS/tarballs/sourcefile_coriArchitect.tar on graal 
%\begin{figure}[htb]
%  \begin{center}
%    \resizebox{.75\linewidth}{!}{\includegraphics{fig/FAST.eps}}
%%    \caption{CoRI architecture}
%   
%  \end{center}
%\end{figure}
...
In this case all possible fields of the vector will be filled (i.e. erase old scalars and append new array to the old array!).
