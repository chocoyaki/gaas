...
\noindent
\fbox{\textbf{NB}} In the maintainer distribution, the bootstrapping
...
\noindent
\fbox{\textbf{NB}} Currently, DIET is developped with at least libtool
...
As the maintainer mode option alters significantly the behaviour of
...
The source files in the other directories are not included directly,
