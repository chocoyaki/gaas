...
export OMNIORB4_INCLUDE_DIR="OMNIORB4_install_directory/include"
...
export PATH="OMNIORB4_install_directory/bin:$PATH"
\end{verbatim}
...
$>$ ./server Sed.cfg\\
$>$./client client.cfg CADD where CADD is one of the service offer by the Sed.
\begin{verbatim}
...
\noindent On the example1.xml file, you have to ckeck PATH and LD\_LIBRARY\_PATH:
...
\noindent After that just follow instructions on the UsersManual (Chapter 9, p. 91).
